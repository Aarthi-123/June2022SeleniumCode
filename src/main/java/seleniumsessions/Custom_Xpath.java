...
public class Custom_Xpath {
	...
	public static void main(String[] args) {
		...
		//htmltag[@attr='value1' and @attr='value2'] u can use or anyone can be true but use always 'and'
		...
		//input[contains(@id,'email')]---u can use the partial text value in contains but in text() u have to use the full text
		...
		//index:
		// (//input[@class='form-control'])[1]---first we have to put it in the rounded bracket means capture group then index value
...
//		By help = By.xpath("(//div[@class='navFooterVerticalRow navAccessibility']//a)[last()]");
		...
		//invalid---oly one className is allowed
...
//		driver.findElement(By.className("login-password")).sendKeys("test@123");
		...
		//*[@id];---17 out of 200;----*entire html will be taken--slower
		//input[@id];----3 out of 200--faster
