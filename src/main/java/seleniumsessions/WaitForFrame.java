...
public class WaitForFrame {
	...
	public static void main(String[] args) {
		...
		//wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(2));//index
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("main"));//name or id
		...
		//driver.switchTo().frame("aarthi");//no such frame exception
