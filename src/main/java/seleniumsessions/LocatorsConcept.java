...
//		driver.findElement(By.name("password")).sendKeys("test@123");
		...
		//100 elements---id=username--1element will be unique bcoz its id
		//100 elements---name=test---5 elements will have the same name so wont be unique
		
//		By.type---NA
		
		//3.className: can be duplicate most of the time for diff elements -- III
//		driver.findElement(By.className("form-control")).sendKeys("aarthi");
...
//		driver.findElement(By.partialLinkText("Forgotten")).click();//first element from the page will be taken for "Forgotten"
...
//		System.out.println(header);
		...
		By warnMesg = By.className("alert");//oly one class at a time ...to search whether its unique className or not, u have press ctrl+f type div.alert to find whether its unique or not 
		...
		String warnMesgText = doGetText(warnMesg);
		System.out.println(warnMesgText);
	}
