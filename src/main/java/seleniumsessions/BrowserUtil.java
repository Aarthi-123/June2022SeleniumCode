...
public class BrowserUtil {
	...
	//it is calling from AmazonTest
	
	private WebDriver driver;//static variable cant support the multiple thread parallely bcoz its store in CMA, so always use non static variable
...
//}
	...
	//calling from testng.xml so removed throws exception
