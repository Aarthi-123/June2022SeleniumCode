...
public class XpathAxes {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.linkText("CONTACTS")).click();// always use the text case what visible in the page
...
//		List<WebElement> contList = driver.findElements(By.xpath("//a[text()='Ali khan']/parent::td/following-sibling::td"));
