...
//		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(15));//dont use implicit wait and explicit wait together 
																		  //it will give the cumulative wait combinations so never use it
